<template>
    <div class="defaultForm">
        ...
        <div class="intro">{{dataForm.bookIntroduction}}</div>
        <div style="margin-top:20px;">
            <div style="float:left;width:25%" >
                <el-button type="text" @click="gotoBookRead(chapter.id)">第十二章  岛上的秘密</el-button>
            </div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        methods: {
            ...
            initData(){
                ...
                this.getRequest('/bookInfo/getDetail.json', {id:id}).then(resp => {
                    if (resp.code == 200) {
