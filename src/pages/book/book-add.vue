            ...
            <el-row :gutter="30" >
                <el-col :span="12">
                    <div class="grid-content">
                        <el-form-item label="所属分类" prop="bookType">
                            <el-select v-model="dataForm.bookType" placeholder="请选择分类">
                ...
                <el-col :span="12" class="row-bg">
                    <div class="grid-content">
                        ...
                        <el-form-item label="数量" prop="bookNum">
                            <el-input v-model.number="dataForm.bookNum" style="width:150px"><template slot="append">本</template></el-input>
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            submitForm(dataForm) {
                ...
                if (valid) {
                    this.postRequest('/bookInfo/addBook.json', this.dataForm).then(resp => {
