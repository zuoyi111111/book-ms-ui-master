<template>
    <div class="defaultForm">
        <el-tabs v-model="activeName" tabPosition="left">
            <el-tab-pane label="类型Id" name="info">
                <!-- <img :src="imageUrl" class="avatar"> -->
                <div style="margin-top:15px">{{dataForm.typeId}}</div>
                <div style="margin-top:15px">{{dataForm.typeName}}</div>
                <div style="margin-top:35px">
                    <el-button @click="$router.back(-1)" size="mini">返回</el-button>
                </div>
            </el-tab-pane>
            <el-tab-pane label="类型名称" name="book">
...
<script>
    export default {
        ...
        methods: {
            gotoBookDetails(id){
                this.$router.push("/book/book-detail/"+id);
            },
            initData(){
                // 详情
