    ...
    <el-container>
      <el-header class="homeHeader">
          ...
          <div>
              ...
              <el-link href="https://github.com/Zealon159/book-ms-ui" target="_blank" style="margin-right: 30px;color: #000000; font-size:14px">
                  ...
                  <el-main style="padding:10px;">
                      <template v-if="this.$router.currentRoute.path=='/home'">
                        <div style="padding:10px">
                                ...
                                <el-col :span="17">
                                    <el-card class="box-card" shadow="hover">
                                        ...
                                        <div class="book-item" v-for="book in books" :key="book.id">
                                            <div class="img"><img width="90" :src="book.bookPic" ></div>
                                            <div class="content">
                                                <div style="height:30px">
                                                    <div class="title">
                                                        <el-link type="text" @click="gotoBookDetails(book.bookId)">{{book.bookName}}</el-link>
                                                    </div>
                                                    <div class="category">
                                                        <el-tag type="success" size="mini">历史穿越</el-tag>
                                                    </div>
                                                </div>
                                    ...
                                    <el-card class="box-card" shadow="hover">
                                        ...
                                        <div v-for="author in authors" :key="author.id">
                                            <div class="author-item">
                                                <div style="float:left"><img class="author-item-img" :src="author.imgUrl"></div>
                            ...
                            <el-row :gutter="20">
                                <el-col :span="17" style="text-align: right; padding:15px 0 20px 0;">
                                    <el-pagination
                                        :page-size="20"
                                        :pager-count="11"
...
import { menus, author } from '../utils/dictionary'
    export default {
        ...
        methods:{
            ...
            getNewBooks() {
                // 获取最新图书
                this.postRequest('/bookInfo/getBookInfo.json', {pageNo: this.pageNo,pageSize: this.pageSize}).then(resp => {
                    if (resp.code && resp.code == 200) {
                        this.books = resp.data.pageData;
